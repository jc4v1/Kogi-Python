...
def check_markings(model, expected_markings : dict[ str, ElementStatus ]) -> None:
...
def set_markings(model, markings: dict[ str, ElementStatus ]) -> None:
...
def generate_combinations(data: dict[str, set[ElementStatus]]) -> set[frozenset[tuple[str, ElementStatus]]]:
    """
